            ...
            <div class="social-links">
                ...
                <?php if (!empty($site['social']['gitlab'])): ?>
                    <a href="<?= e($site['social']['gitlab']) ?>" target="_blank" rel="noopener" title="GitLab">
                        <svg class="icon" viewBox="0 0 24 24" fill="currentColor"><path d="M13.5 1.5h1L18 5v13.5l-3.5 3.5h-1L9 18.5V5l3.5-3.5zm-1 1.73L7.5 6v10l3 3V1.73zm5 0L18.5 6v10l-3 3V1.73zM12 6L8 10l4 4 4-4-4-4z"/></svg>
                    </a>
                <?php endif; ?>
